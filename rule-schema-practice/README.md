...
A dependency-free practice site for the first three Fitch inference rules: `&I`, `&E`, and `→E`.

To use it, copy this entire folder and open `index.html` in a browser. It does not require a server, package manager, build command, web font, or internet connection.
